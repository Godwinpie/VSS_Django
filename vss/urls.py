...
urlpatterns = [
    ...
    path("vss/", include("apps.vss.urls")),
    #custom insign url start

    path('api/subscriptions/', include('apps.subscription.urls')),
    path('api/firms/', include('apps.firm.urls')),
    path('api/sales/', include('apps.orders.urls')),
    path('api/norm/', include('apps.norm.urls')),

    #custom insign url end
