...
class TeamMemberManagementViewTest(TestCase):
    ...
    def setUp(self):
        ...
        self.admin = Customer.objects.create(username="tito@redsox.com")
        self.admin2 = Customer.objects.create(username="alex@redsox.com")
        self.member = Customer.objects.create(username="papi@redsox.com")
        self.member2 = Customer.objects.create(username="manny@redsox.com")
