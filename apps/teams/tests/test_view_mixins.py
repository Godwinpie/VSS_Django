...
class TeamMixinTest(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.sox_admin = Customer.objects.create(username="tito@redsox.com")
        cls.sox_member = Customer.objects.create(username="papi@redsox.com")
        ...
        cls.yanks_admin = Customer.objects.create(username="joe.torre@yankees.com")
        cls.yanks_member = Customer.objects.create(username="derek.jeter@yankees.com")
