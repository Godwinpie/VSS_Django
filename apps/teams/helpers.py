...
def get_default_team_name_for_user(user: Customer):
...
def get_default_team_for_user(user: Customer):
...
def create_default_team_for_user(user: Customer, team_name: str = None):
